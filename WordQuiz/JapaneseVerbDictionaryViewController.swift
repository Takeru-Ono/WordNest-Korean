//
//  Japanese NounDictionaryViewController.swift
//  WordQuiz
//
...
class JapaneseVerbDictionaryViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    func setupUI() {
        ...
        tableView.register(JapaneseVerbCell.self, forCellReuseIdentifier: "WordCell")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "WordCell", for: indexPath) as? JapaneseVerbCell else {
            fatalError("Failed to dequeue JapaneseVerbCell")
        }
...
class JapaneseVerbCell: UITableViewCell {
