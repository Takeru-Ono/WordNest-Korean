...
protocol CorrectAnswerViewControllerDelegate: AnyObject {
...
class CorrectAnswerViewController: UIViewController {
    ...
    func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            questionContainerView.bottomAnchor.constraint(equalTo: exampleStackView.bottomAnchor, constant: 20),// コンテナを少し大きく
    ...
    @objc func playAudioButtonTapped(_ sender: UIButton) {
        ...
        case playAudioButton1:
            choiceText = incorrectChoices[0].1
        case playAudioButton2:
            choiceText = incorrectChoices[1].1
        case playAudioButton3:
            choiceText = incorrectChoices[2].1
        default:
            break
        }
    ...
    @objc func dismissViewController() {
        dismiss(animated: true) {
            self.delegate?.didCloseCorrectAnswerViewController()
        }
    }
}
