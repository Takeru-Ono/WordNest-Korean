...
extension EndViewController_Rapid.Question {
...
class EndViewController_Rapid: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
//        print("EndViewController_Rapid loaded with quiz mode: \(selectedQuizMode)")
    ...
    func setupUI() {
        ...
        tableView.register(RapidModeQuestionTableViewCell_Rapid.self, forCellReuseIdentifier: "RapidModeQuestionTableViewCell_Rapid")
...
//            print("Failed to convert QuestionProtocol to EndViewController_Normal.Question")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "RapidModeQuestionTableViewCell_Rapid", for: indexPath) as? RapidModeQuestionTableViewCell_Rapid else {
            fatalError("Failed to dequeue RapidModeQuestionTableViewCell_Rapid")
        }
...
class RapidModeQuestionTableViewCell_Rapid: UITableViewCell {
    ...
    func configure(
        ...
        exampleAudioButton.isHidden = !isExpanded || example == nil
