//
//  EndViewController_JP_Normal.swift
//  WordQuiz
//
//  Created by Takeru Ono on 2024/12/04.
//

import UIKit
import AVFoundation

extension EndViewController_JP_Normal.Question {
...
class EndViewController_JP_Normal: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func setupUI() {
        ...
        tableView.register(SimpleModeQuestionTableViewCell_JP_Normal.self, forCellReuseIdentifier: "SimpleModeQuestionTableViewCell_JP_Normal")
...
//            print("Failed to load favorite questions: \(error)")
    ...
    func toggleFavorite(question: QuestionProtocol, for mode: String) {
        if let convertedQuestion = EndViewController_JP_Normal.Question(from: question) {
...
//            print("Failed to convert QuestionProtocol to EndViewController_Normal.Question")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(
            withIdentifier: "SimpleModeQuestionTableViewCell_JP_Normal",
            for: indexPath
        ) as? SimpleModeQuestionTableViewCell_JP_Normal else {
            fatalError("Failed to dequeue SimpleModeQuestionTableViewCell_JP_Normal")
        }
...
class SimpleModeQuestionTableViewCell_JP_Normal: UITableViewCell {
